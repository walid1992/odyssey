package com.syswin.toon.lib.martian.vh;
...
public class MartianAdapterViewHolder<T> extends BaseViewHolder<T> implements IViewHolder {
    ...
    @Override
    public IViewHolder setTextColorInt(int viewId, int textColor) {
        mMartianViewHolder.setTextColorInt(viewId, textColor);
        return this;
    }

    @Override
    public IViewHolder setTextColorRes(int viewId, @ColorRes int textColor) {
        mMartianViewHolder.setTextColorRes(viewId, textColor);
        return this;
    }
    ...
    @Override
    public IViewHolder setBackgroundColorInt(int viewId, @ColorInt int color) {
        mMartianViewHolder.setBackgroundColorInt(viewId, color);
        return this;
    }

    @Override
    public IViewHolder setBackgroundColorRes(int viewId, @ColorRes int color) {
        mMartianViewHolder.setBackgroundColorRes(viewId, color);
        return this;
    }

    @Override
    public IViewHolder setBackgroundDrawableRes(int viewId, @DrawableRes int backgroundRes) {
        mMartianViewHolder.setBackgroundDrawableRes(viewId, backgroundRes);
        return this;
    }
