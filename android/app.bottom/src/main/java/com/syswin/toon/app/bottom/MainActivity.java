...
import com.syswin.toon.app.bottom.bean.TagBean;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.syswin.toon.appstub.event.GlobalEvent.register(this, com.syswin.toon.appstub.event.bean.Key.LOGIN_SUCCESS).then(res -> {
